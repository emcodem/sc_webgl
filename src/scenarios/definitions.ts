...
// scenarios/runtime.ts) — pos/quat here are unused placeholders, same convention as 'evasive' spawns.
...
export interface MergeDrillOptions { rangeBubbleRadius: number; }

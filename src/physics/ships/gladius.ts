...
// numbers trace back to, and CLAUDE.md is explicit that nothing here gets "cleaned up" or retuned
...
// physics/flightModel.ts). Recorded here so it's available once a real mass-to-`mass` conversion
// (or a switch to using massKg directly) is worked out.
//
...
export const GLADIUS_RAW: RawShipMeasurement = {
  ...
  // unchanged; capacitor fields are new, per-gun, and hand-tuned/estimated pending a real capture).

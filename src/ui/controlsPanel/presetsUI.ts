...
// Ported from the original project's ui/controlsPanel/presetsUI.ts.
...
// Called once at startup — re-applies the last preset chosen (saved or loaded), if any. Loading
// it (via PresetStore) already refreshes any UI that cares — see configRegistry's
// onConfigApplied subscribers — so this only updates preset-picker UI.
